...
class Report extends CI_Controller {
	...
	public function so_list_by_delivery_date() {
		...
		$input_param = [
			"delivery_date_from" 	=> $this->input->post("delivery_date_from", TRUE), // Required Parameter
			"delivery_date_to" 		=> $this->input->post("delivery_date_to", TRUE), // Required Parameter
