  ...
  <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
    ...
    <div class="col-md-6 order-md-2 mb-4">
	  ...
	  <?php foreach($detail as $row) {
		...
		echo '          	 <img src="'.base_url() . 'assets/prod_img/' . $row["prod_img"].'" class="card-img" height="80" width="80"/>';					
					}
		echo'			</div>
					<div>
					...
					<span class="text-muted  ml-auto">P'.number_format($row["total_price"],2).'</span>
				</li>
